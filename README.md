...
- **4 playable roles**: Warrior, Mage, Rogue, Cleric, each with its own stats, growth and signature skill (Power Strike, Fireball, Backstab, Mend)
...
- [ ] Shops and gold sinks beyond the inn
- [ ] Random loot drops and rarities
- [ ] More skills per role, unlocked by level
