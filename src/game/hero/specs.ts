...
export const SPECS: Spec[] = [
  // warrior
  {
    ...
    signature: sig({
      name: "Immovable", description: "Plant your feet: a crushing counter-blow.", mpCost: 7,
      kind: "damage", multiplier: 2.2, stat: "strength",
    }),
  },
  {
    id: "warlord",
    ...
    signature: sig({
      name: "War Cry", description: "A roar and a wide swing that can stagger.", mpCost: 8,
      kind: "damage", multiplier: 1.8, stat: "strength",
  ...
  // mage
  {
    ...
    signature: sig({
      name: "Inferno", description: "The room becomes a furnace.", mpCost: 11,
      kind: "damage", multiplier: 2.4, stat: "intelligence",
  ...
  },
  {
    ...
    signature: sig({
      name: "Thunderlash", description: "A whipcrack of lightning that can stun.", mpCost: 9,
      kind: "damage", multiplier: 2.0, stat: "intelligence",
  ...
  // rogue
  {
    ...
    signature: sig({
      name: "Killing Blow", description: "The artery, found.", mpCost: 9,
      kind: "damage", multiplier: 2.6, stat: "dexterity",
    }),
  },
  {
    id: "trickster",
    ...
    signature: sig({
      name: "Smoke Bomb", description: "Vanish, strike, reappear grinning. May stun.", mpCost: 8,
      kind: "damage", multiplier: 1.6, stat: "dexterity",
  ...
  // cleric
  {
    ...
    passive: { defense: 2 },
    signature: sig({
      name: "Radiant Hammer", description: "A hammer of light falls.", mpCost: 8,
      kind: "damage", multiplier: 2.2, stat: "intelligence",
    }),
  },
  {
    id: "oracle",
    ...
    passive: { killRefundMp: 4 },
    signature: sig({
      name: "Foresight", description: "Heal what was about to happen.", mpCost: 8,
      kind: "heal", multiplier: 3.0, stat: "intelligence",
    }),
  },
  // ranger
  {
    ...
    passive: { critChance: 0.15 },
    signature: sig({
      name: "Piercing Shot", description: "Through armor, through excuses.", mpCost: 8,
      kind: "damage", multiplier: 2.4, stat: "dexterity",
    }),
  },
  {
    id: "beastmaster",
    ...
    signature: sig({
      name: "Wolf Companion", description: "Your shadow has teeth: a savaging that poisons.", mpCost: 8,
      kind: "damage", multiplier: 1.7, stat: "dexterity",
  ...
  // paladin
  {
    ...
    signature: sig({
      name: "Final Verdict", description: "The gavel is a warhammer.", mpCost: 9,
      kind: "damage", multiplier: 2.3, stat: "strength",
    }),
  },
  {
    id: "guardian",
    ...
    passive: { defense: 3, stunResist: true },
    signature: sig({
      name: "Aegis Strike", description: "The shield answers for you.", mpCost: 7,
      kind: "damage", multiplier: 1.9, stat: "strength",
    }),
  },
  // necromancer
  {
    ...
    signature: sig({
      name: "Pestilence", description: "A sickness with a name on it.", mpCost: 10,
      kind: "damage", multiplier: 1.6, stat: "intelligence",
  ...
  },
  {
    ...
    signature: sig({
      name: "Bone Armor", description: "The dead stand between you and harm, then lash out.", mpCost: 8,
      kind: "damage", multiplier: 1.9, stat: "intelligence",
    }),
  },
];
