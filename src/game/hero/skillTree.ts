...
export const SKILL_TREES: Record<RoleId, SkillNode[]> = {
  warrior: [
    ...
    upgrade("warrior_power_strike_2", "warrior_power_strike", 0, "Power Strike II", "Power Strike hits much harder.", {
      multiplier: 2.4,
    }),
    passive(
      "warrior_executioner",
      "warrior_power_strike_2",
      0,
      2,
      "Executioner",
      "+40% damage against enemies below 30% HP.",
      { lowHpBonus: 0.4 },
    ),
    active("warrior_shield_slam", 1, "Shield Slam", "A staggering bash that can stun for a turn.", {
      name: "Shield Slam",
      description: "A staggering bash.",
      mpCost: 6,
      kind: "damage",
      multiplier: 1.1,
      stat: "strength",
    ...
    passive("warrior_unshakeable", "warrior_iron_skin", 1, 2, "Unshakeable", "You cannot be stunned.", {
      stunResist: true,
    }),
    active("warrior_berserk", 2, "Berserk", "Reckless fury: massive damage, costs 8 HP.", {
      name: "Berserk",
      description: "Reckless fury.",
      mpCost: 5,
      hpCost: 8,
      kind: "damage",
      multiplier: 2.7,
    ...
    capstone(
      "warrior_skullsplitter",
      "warrior_executioner",
      0,
      "Skullsplitter",
      "One blow to end arguments: enormous STR damage.",
      {
        name: "Skullsplitter",
        description: "One blow to end arguments.",
        mpCost: 12,
        kind: "damage",
        multiplier: 3.4,
        stat: "strength",
    ...
    passive(
      "warrior_mountainheart",
      "warrior_unshakeable",
      1,
      3,
      "Mountainheart",
      "+30 max HP and +1 DEF, permanently.",
      { defense: 1 },
      { maxHp: 30 },
    ),
    passive("warrior_warpath", "warrior_rampage", 2, 3, "Warpath", "+10% chance to crit for 1.5x damage.", {
      critChance: 0.1,
    }),
  ],
  mage: [
    ...
    passive(
      ...
      2,
      "Cinders",
      "Plain attacks have a 20% chance to set enemies burning.",
      {
    ...
    active("mage_frost_nova", 2, "Frost Nova", "A blast of cold that can freeze the enemy solid.", {
      name: "Frost Nova",
      description: "Cold blast, may stun.",
      mpCost: 9,
      kind: "damage",
      multiplier: 1.5,
      stat: "intelligence",
    ...
    capstone("mage_meteor", "mage_cinders", 0, "Meteor", "Calls a piece of the sky down: colossal INT damage.", {
      name: "Meteor",
      description: "A piece of the sky.",
      mpCost: 14,
      kind: "damage",
      multiplier: 3.6,
      stat: "intelligence",
    ...
    passive(
      ...
      3,
      "Archmage",
      "+20 max MP and kills refund 2 more MP.",
      { killRefundMp: 2 },
      { maxMp: 20 },
    ),
    passive("mage_rimeguard", "mage_winters_grace", 2, 3, "Rimeguard", "A sheath of ice: +2 DEF and +5% flee.", {
      defense: 2,
      fleeBonus: 0.05,
    }),
  ],
  rogue: [
    active("rogue_backstab", 0, "Backstab", "Strikes a vital spot for heavy dexterity damage.", {
      name: "Backstab",
      description: "Strike a vital spot.",
      mpCost: 5,
      kind: "damage",
      multiplier: 2.0,
      stat: "dexterity",
    ...
    passive("rogue_keen_edge", "rogue_backstab_2", 0, 2, "Keen Edge", "+15% chance to crit for 1.5x damage.", {
      critChance: 0.15,
    }),
    ...
    passive("rogue_toxin_ward", "rogue_virulence", 1, 2, "Toxin Ward", "You cannot be poisoned.", {
      poisonResist: true,
    }),
    active("rogue_shadowstep", 2, "Shadowstep", "Vanish and strike from behind for devastating damage.", {
      name: "Shadowstep",
      description: "Devastating ambush.",
      mpCost: 10,
      kind: "damage",
      multiplier: 3.0,
      stat: "dexterity",
    ...
    capstone("rogue_deathblow", "rogue_keen_edge", 0, "Deathblow", "The knife you never see: extreme DEX damage.", {
      name: "Deathblow",
      description: "The knife you never see.",
      mpCost: 12,
      kind: "damage",
      multiplier: 3.5,
      stat: "dexterity",
    ...
    passive(
      ...
      3,
      "Venom Master",
      "Plain attacks have a 25% chance to poison.",
      {
    ...
    passive(
      ...
      3,
      "Ghostwalk",
      "+10% flee and +10% gold: leave rich, leave alive.",
      { fleeBonus: 0.1, goldBonus: 0.1 },
    ),
  ],
  cleric: [
    ...
    capstone(
      ...
      0,
      "Divine Word",
      "A word that unmakes wounds: massive heal and full cleanse.",
      {
        name: "Divine Word",
        description: "Unmakes wounds.",
        mpCost: 14,
        kind: "heal",
        multiplier: 4.0,
        stat: "intelligence",
    ...
    passive(
      ...
      3,
      "Sainthood",
      "+15 max HP, +10 max MP and +2 DEF, permanently.",
      { defense: 2 },
      { maxHp: 15, maxMp: 10 },
    ),
  ],
  ranger: [
    active("ranger_aimed_shot", 0, "Aimed Shot", "A measured arrow to a weak point.", {
      name: "Aimed Shot",
      description: "A measured arrow.",
      mpCost: 4,
      kind: "damage",
      multiplier: 1.9,
      stat: "dexterity",
    }),
    upgrade("ranger_aimed_shot_2", "ranger_aimed_shot", 0, "Aimed Shot II", "Aimed Shot bites deeper.", {
      multiplier: 2.4,
    }),
    passive("ranger_deadeye", "ranger_aimed_shot_2", 0, 2, "Marksman's Eye", "+10% chance to crit for 1.5x damage.", {
      critChance: 0.1,
    }),
    active("ranger_barbed_arrow", 1, "Barbed Arrow", "A cruel arrowhead that poisons the wound.", {
      name: "Barbed Arrow",
      description: "Poisons the wound.",
      mpCost: 6,
      kind: "damage",
      multiplier: 1.1,
      stat: "dexterity",
    ...
    passive("ranger_fieldcraft", "ranger_barbed_arrow", 1, 1, "Fieldcraft", "+15 carry weight, always.", {
      carryBonus: 15,
    }),
    ...
    capstone("ranger_heartseeker", "ranger_deadeye", 0, "Heartseeker", "One arrow, one answer: enormous DEX damage.", {
      name: "Heartseeker",
      description: "One arrow, one answer.",
      mpCost: 12,
      kind: "damage",
      multiplier: 3.3,
      stat: "dexterity",
    ...
    passive(
      ...
      3,
      "Wolfblood",
      "+20 max HP and poison never touches you.",
      { poisonResist: true },
      { maxHp: 20 },
    ),
    passive(
  ...
  paladin: [
    active("paladin_judgement", 0, "Judgement", "A blessed blow of righteous strength.", {
      name: "Judgement",
      description: "A blessed blow.",
      mpCost: 5,
      kind: "damage",
      multiplier: 1.7,
      stat: "strength",
    }),
    upgrade("paladin_judgement_2", "paladin_judgement", 0, "Judgement II", "Judgement lands heavier.", {
      multiplier: 2.2,
    }),
    passive(
      "paladin_retribution",
    ...
    active("paladin_consecrate", 2, "Consecrate", "Holy fire that clings.", {
      name: "Consecrate",
      description: "Holy fire that clings.",
      mpCost: 9,
      kind: "damage",
      multiplier: 1.5,
      stat: "strength",
    ...
    upgrade("paladin_purifier", "paladin_consecrate", 2, "Purifier", "Consecrate burns hotter.", {
      inflicts: { kind: "burn", chance: 0.9, turns: 3, power: 8 },
    }),
    ...
    capstone(
      ...
      0,
      "Wrath of Heaven",
      "The sky takes a side: massive STR damage.",
      {
        name: "Wrath of Heaven",
        description: "The sky takes a side.",
        mpCost: 12,
        kind: "damage",
        multiplier: 3.2,
        stat: "strength",
  ...
  necromancer: [
    active("necro_soul_bolt", 0, "Soul Bolt", "A lash of stolen life.", {
      name: "Soul Bolt",
      description: "A lash of stolen life.",
      mpCost: 5,
      kind: "damage",
      multiplier: 2.0,
      stat: "intelligence",
    ...
    passive(
      ...
      2,
      "Grave Touch",
      "Plain attacks have a 20% chance to poison.",
      {
    ...
    active("necro_grave_chill", 2, "Grave Chill", "The cold of the tomb; the enemy may freeze.", {
      name: "Grave Chill",
      description: "The cold of the tomb.",
      mpCost: 9,
      kind: "damage",
      multiplier: 1.4,
      stat: "intelligence",
    ...
    capstone(
      ...
      0,
      "Soul Rend",
      "Tears the seam between body and soul: enormous INT damage.",
      {
        name: "Soul Rend",
        description: "Tears the seam.",
        mpCost: 13,
        kind: "damage",
        multiplier: 3.3,
        stat: "intelligence",
    ...
    capstone(
      ...
      1,
      "Plaguebringer",
      "Rot given ambition: damage and a vicious lasting poison.",
      {
        name: "Plaguebringer",
        description: "Rot given ambition.",
        mpCost: 12,
        kind: "damage",
        multiplier: 1.8,
        stat: "intelligence",
    ...
    passive(
      ...
      3,
      "Lichbone",
      "+20 max HP and +10 max MP, permanently.",
      {},
      { maxHp: 20, maxMp: 10 },
    ),
  ],
